			...
			<div class="col-md-6">
				<div class="panel panel-danger">
					<div class="panel-heading">
						<h3 class="panel-title">Form Edit Data Barang</h3>
					</div>
					<div class="panel-body">
						<form role="form" method="POST" action="{{ route('barang.edit') }}">
					    {{ csrf_field() }}
					    	<div class="form-group">
					    		<label>Nama Barang</label>
					    		<input type="text" name="nama_barang" class="form-control" required="" placeholder="coba">
					    	</div>
                            <div class="form-group">
